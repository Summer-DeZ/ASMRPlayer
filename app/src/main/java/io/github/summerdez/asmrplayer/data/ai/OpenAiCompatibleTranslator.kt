...
class OpenAiCompatibleTranslator(
    ...
    companion object {
        ...
        fun parseOrderedTranslationContent(content: String, sourceLines: List<SubtitleLine>): List<SubtitleLine> {
            return AiTranslationJsonParser.parseOrderedTranslationContent(content, sourceLines)
        }

        fun parseSceneContextContent(content: String, finishReason: String): SceneContext {
            return AiTranslationJsonParser.parseSceneContextContent(content, finishReason)
        }

        fun parseTranslationObject(content: String, sourceLines: List<SubtitleLine>): List<SubtitleLine> {
            return AiTranslationJsonParser.parseTranslationObject(content, sourceLines)
        }

        fun parseTranslationContent(content: String, sourceLines: List<SubtitleLine>): List<SubtitleLine> {
            return AiTranslationJsonParser.parseTranslationContent(content, sourceLines)
        }
        ...
        fun parseCompleteTranslationContent(
            ...
            return AiTranslationJsonParser.parseCompleteTranslationContent(content, finishReason, sourceLines)
        }

        fun parseLoose(content: String, sourceLines: List<SubtitleLine>): List<SubtitleLine> {
            return AiTranslationJsonParser.parseLoose(content, sourceLines)
        }

        fun translationQualityWarning(lines: List<SubtitleLine>): String {
            return AiTranslationJsonParser.translationQualityWarning(lines)
        }
    }
}
