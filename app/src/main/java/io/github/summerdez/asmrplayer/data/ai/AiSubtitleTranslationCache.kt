...
internal class AiSubtitleTranslationCache(
    ...
    fun load(
        ...
        return runCatching {
            ...
            if (metadata[KEY_TRACK_ID] != target.trackId ||
                ...
                metadata[KEY_SOURCE_SIGNATURE] != sourceSignature(sourceLines)
            ) {
                return@runCatching null
            }
            lines
    ...
    fun save(
        ...
        val completed = translatedLines.filter { it.translatedText.isNotBlank() }
        ...
        val body = buildString {
            ...
            appendLine("$KEY_SOURCE_SIGNATURE=${encode(sourceSignature(sourceLines))}")
    ...
    private fun sourceSignature(lines: List<SubtitleLine>): String {
    ...
    private companion object {
        ...
        const val PROMPT_VERSION = "asr-ja-zh-v1"
