...
static PFN_vkGetPhysicalDeviceFeatures2 ggml_vk_get_physical_device_features_2 = nullptr;

static void ggml_vk_get_physical_device_features2(VkPhysicalDevice physical_device, VkPhysicalDeviceFeatures2 * features) {
    if (ggml_vk_get_physical_device_features_2 == nullptr) {
        ggml_vk_get_physical_device_features_2 = reinterpret_cast<PFN_vkGetPhysicalDeviceFeatures2>(
    ...
    if (ggml_vk_get_physical_device_features_2 == nullptr) {
        throw vk::SystemError(vk::Result::eErrorFeatureNotPresent, "vkGetPhysicalDeviceFeatures2 not available");
    }
    ggml_vk_get_physical_device_features_2(physical_device, features);
}
